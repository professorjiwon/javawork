...
public class T01_2Array {
	...
	public static void main(String[] args) {
		...
		System.out.println("score2[0]의 열의 길이 : " + score[0].length);
		System.out.println("score2[1]의 열의 길이 : " + score[1].length);
		System.out.println("score2[2]의 열의 길이 : " + score[2].length);
